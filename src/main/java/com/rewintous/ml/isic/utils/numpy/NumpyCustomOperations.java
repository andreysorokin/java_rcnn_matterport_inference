package com.rewintous.ml.isic.utils.numpy;
...
public class NumpyCustomOperations {

    private NumpyCustomOperations() {
    }

    public static INDArray arange(double start, double end, double step) {
        int elements = (int) ((end - start) / step);
        return Nd4j.linspace(start, start + elements * step,  elements );
    }
